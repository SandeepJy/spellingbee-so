...
struct MainView: View {
    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            // --- Home tab ---
            NavigationView {
                HomeTabContent(showCreateGameView: $showCreateGameView)
...
// MARK: - Home tab content (extracted from old MainView body)
...
struct HomeTabContent: View {
    ...
    var body: some View {
                ...
                if !gameManager.isDataLoaded {
                    ...
                    Button(action: { showCreateGameView = true }) {
                        HStack {
                            ...
                            Text("Start New Game").fontWeight(.semibold)
                        }
        ...
        .refreshable { await gameManager.loadData() }
    }

    private func sortedUserGames() -> [MultiUserGame] {
